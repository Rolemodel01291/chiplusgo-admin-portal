		...
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex flex-auto flex-col container z-10 h-full">
				...
				<div className={classes.wrapper}>
					{(props.leftSidebarHeader || props.leftSidebarContent || props.leftSidebarHeader1) && (
						<FusePageSimpleSidebar
							position="left"
							header={props.leftSidebarHeader}
							header1={props.leftSidebarHeader1}
					...
					>
						...
						{props.header1 && <div className={classes.header1}>{props.header1}</div>}
					...
					{(props.rightSidebarHeader || props.rightSidebarContent || props.rightSidebarHeader1 ) && (
						<FusePageSimpleSidebar
							position="right"
							header={props.rightSidebarHeader}
							header1 = {props.rightSidebarHeader1}
...
FusePageSimple.propTypes = {
	...
	rightSidebarHeader1: PropTypes.node,
