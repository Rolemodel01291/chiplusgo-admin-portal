...
function HiddenDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="description">Quickly and responsively toggle the visibility value of components and more with the hidden utilities.</Typography>
            ...
            <Typography className="mb-16" component="div">All elements are visible unless <strong>they are explicitly hidden</strong>.
                ...
                or you can use it in conjunction with the <a href="/components/grid/"><code>{`Grid`}</code></a> component.</Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">How it works</Typography>
            <Typography className="mb-16" component="div">Hidden works with a range of breakpoints e.g. <code>{`xsUp`}</code> or <code>{`mdDown`}</code>, or one or more breakpoints
                e.g. <code>{`only='sm'`}</code> or <code>{`only={['md', 'xl']}`}</code>.
...
`}
            ...
            <Typography className="mb-16" component="div">If you are using server-side rendering, you can set <code>{`implementation="css"`}</code> if you don&#39;t want the browser to re-flow your
                content on the screen.</Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Breakpoint up</Typography>
            <Typography className="mb-16" component="div">Using any breakpoint <code>{`up`}</code> property, the given <em>children</em> will be hidden <em>at or above</em> the
            ...
            <Typography className="mb-16" component="div">Using any breakpoint <code>{`down`}</code> property, the given <em>children</em> will be hidden <em>at or below</em> the
                breakpoint.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div">Using the breakpoint <code>{`only`}</code> property, the given <em>children</em> will be hidden <em>at</em> the specified
                breakpoint(s).</Typography>
            ...
            <Typography className="mb-16" component="div">It is quite common to alter <code>{`Grid`}</code> at different responsive breakpoints, and in many cases, you want to hide some of those
                elements.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
