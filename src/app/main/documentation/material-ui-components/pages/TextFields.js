...
function TextFieldsDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div"><a href="https://material.io/design/components/text-fields.html">Text fields</a> allow users to enter text into a UI. They typically appear in
                forms and dialogs.</Typography>
            ...
            /></Typography>
            <Typography className="mb-16" component="div"><strong>Note:</strong> The standard variant of the <code>{`TextField`}</code> is no longer documented in the <a href="https://material.io/">Material
                Design guidelines</a>
            ...
            <Typography className="mb-16" component="div">Standard form attributes are supported e.g. <code>{`required`}</code>, <code>{`disabled`}</code>, <code>{`type`}</code>, etc. as well as
                a <code>{`helperText`}</code> which is used to give context about a field’s input, such as how the input will be used.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div">The <code>{`error`}</code> prop toggles the error state, the <code>{`helperText`}</code> prop can then be used to provide feedback to the user
                about the error.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div">The <code>{`multiline`}</code> prop transforms the text field into a <a
                href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea">textarea</a> or a <a href="/components/textarea-autosize/">TextareaAutosize</a>.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div"><code>{`margin`}</code> prop can be used to alter the vertical spacing of inputs.
            ...
            <Typography className="mb-16" component="div">You might also have noticed that some native HTML input properties are missing from the <code>{`TextField`}</code> component.
                This is on purpose.
                ...
                use <code>{`inputProps`}</code> (and <code>{`InputProps`}</code>, <code>{`InputLabelProps`}</code> properties) if you want to avoid some boilerplate.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            /></Typography>
            <Typography className="mb-16" component="div">Customization does not stop at CSS, you can use composition to build custom components and give your app a unique feel.
            ...
            /></Typography>
            <Typography className="mb-16" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/styles/text-field">MUI Treasury&#39;s customization
...
`}
            ...
            <Typography className="text-24 mt-32 mb-8" component="h3">Floating label</Typography>
            <Typography className="mb-16" component="div">The floating label is absolutely positioned, it won&#39;t impact the layout of the page.
                You need to make sure that the input is larger than the label to display correctly.</Typography>
...
`}
            ...
            <Typography className="mb-16" component="div">In order for the text field to be accessible, <strong>the input should be linked to the label and the helper text</strong>. The underlying DOM
                nodes should have this structure:</Typography>
...
`}
            ...
            <ul>
                <li><a href="https://github.com/stackworx/formik-material-ui">formik-material-ui</a> Bindings for using Material-UI with <a href="https://jaredpalmer.com/formik">formik</a>.</li>
