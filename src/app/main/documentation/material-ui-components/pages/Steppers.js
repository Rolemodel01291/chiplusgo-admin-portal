...
function SteppersDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div"><a href="https://material.io/archive/guidelines/components/steppers.html">Steppers</a> display progress through a sequence of logical and
                numbered steps. They may also be used for navigation.
            ...
            <blockquote>
                <Typography className="mb-16" component="div"><strong>Note:</strong> Steppers are no longer documented in the <a href="https://material.io/">Material Design guidelines</a>, but
                    Material-UI will continue to support them.</Typography>
            </blockquote>
            <Typography className="text-32 mt-32 mb-8" component="h2">Horizontal Stepper</Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Linear</Typography>
            ...
            <Typography className="mb-16" component="div">This example also shows the use of an optional step by placing the <code>{`optional`}</code> property on the
                second <code>{`Step`}</code> component. Note that it&#39;s up to you to manage when an optional step is skipped. Once you&#39;ve determined this for a particular step you must
                set <code>{`completed={false}`}</code> to signify that even though the active step index has gone beyond the optional step, it&#39;s not actually complete.</Typography>
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Linear - Alternative Label</Typography>
            <Typography className="mb-16" component="div">Labels can be placed below the step icon by setting the <code>{`alternativeLabel`}</code> prop on
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Customized Stepper</Typography>
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Non-linear</Typography>
            ...
            <Typography className="mb-16" component="div">The use of the <code>{`StepButton`}</code> here demonstrates clickable step labels, as well as setting the <code>{`completed`}</code>
            ...
            <Typography className="text-24 mt-32 mb-8" component="h3">Text</Typography>
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Text with Carousel effect</Typography>
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Dots</Typography>
            ...
            /></Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Progress</Typography>
            <Typography className="mb-16" component="div">Use a progress bar when there are many steps, or if there are steps that need to be inserted during the process (based on responses to earlier
                steps).</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
