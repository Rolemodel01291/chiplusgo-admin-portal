...
function AppBarDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div">The <a href="https://material.io/design/components/app-bars-top.html">top App Bar</a> provides content and actions related to the current
                screen. It’s used for branding, screen titles, navigation, and actions.</Typography>
            ...
            <Typography className="mb-16" component="div">When you render the app bar position fixed, the dimension of the element doesn&#39;t impact the rest of the page. This can cause some part of
                your content to be invisible, behind the app bar. Here are 3 possible solutions:</Typography>
            <ol>
...
`}
            ...
            <ol>
                <li><Typography className="mb-16" component="div"><code>{`options`}</code> (<em>Object</em> [optional]):</Typography>
                    <ul>
                        <li><code>{`options.disableHysteresis`}</code> (<em>Boolean</em> [optional]): Defaults to <code>{`false`}</code>. Disable the hysteresis. Ignore the scroll direction when
                            determining the <code>{`trigger`}</code> value.
                        </li>
                        <li><code>{`options.target`}</code> (<em>Node</em> [optional]): Defaults to <code>{`window`}</code>.</li>
                        <li><code>{`options.threshold`}</code> (<em>Number</em> [optional]): Defaults to <code>{`100`}</code>. Change the <code>{`trigger`}</code> value when the vertical scroll
