...
function AccordionDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="text-44 mt-32 mb-8" component="h1">Accordion</Typography>
            <Typography className="description">Accordions contain creation flows and allow lightweight editing of an element.</Typography>

            <Typography className="mb-16" component="div"><a href="https://material.io/archive/guidelines/components/expansion-panels.html">An accordion</a> is a lightweight container that may either
                stand alone or be connected to a larger surface, such as a card.</Typography>
            <blockquote>
                <Typography className="mb-16" component="div"><strong>Note:</strong> Accordions are no longer documented in the <a href="https://material.io/">Material Design guidelines</a>, but
                    Material-UI will continue to support them. It was formerly known as the &quot;expansion panel&quot;.</Typography>
            </blockquote>
            <Typography className="text-32 mt-32 mb-8" component="h2">Simple accordion</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/accordion/SimpleAccordion.js').default}
            ...
            <Typography className="mb-16" component="div">Extend the default behavior to create an accordion with the <code>{`Accordion`}</code> component.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/accordion/ControlledAccordions.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/accordion/ControlledAccordions.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Customized accordions</Typography>
            ...
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/accordion/CustomizedAccordions.js').default}
            ...
            <Typography className="mb-16" component="div">In order to put an action such as a <code>{`Checkbox`}</code> or a button inside of the <code>{`AccordionSummary`}</code>, you need to stop
                the propagation of the focus and click events to prevent the accordion from
                ...
                the label of the parent button that controls the accordion expansion.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/accordion/ActionsInAccordionSummary.js').default}
            ...
            <Typography className="mb-16" component="div">The content of Accordions is mounted by default even if the accordion is not expanded.
...
`}
            ...
            <Typography className="mb-16" component="div">Multiple columns can be used to structure the content, and a helper text may be added to the accordion to assist the user.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/accordion/DetailedAccordion.js').default}
