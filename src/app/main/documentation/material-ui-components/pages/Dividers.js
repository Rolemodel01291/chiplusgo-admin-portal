...
function DividersDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div">You can also render a divider vertically using the <code>{`orientation`}</code> prop.
                Note the use of the <code>{`flexItem`}</code> prop to accommodate for the flex container.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
