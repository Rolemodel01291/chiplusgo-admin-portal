...
function PopoverDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div">This demonstrates how to use the <code>{`Popover`}</code> component to implement a popover behavior based on the mouse over
                event.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
