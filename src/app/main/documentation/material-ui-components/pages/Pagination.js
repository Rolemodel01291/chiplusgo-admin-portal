...
function PaginationDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="text-44 mt-32 mb-8" component="h1">Pagination</Typography>
            ...
            <Typography className="text-32 mt-32 mb-8" component="h2">Basic pagination</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/BasicPagination.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/BasicPagination.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Outlined pagination</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationOutlined.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationOutlined.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Rounded pagination</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationRounded.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationRounded.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Pagination size</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationSize.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationSize.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Buttons</Typography>
            <Typography className="mb-16" component="div">You can optionally enable first-page and last-page buttons, or disable the previous-page and next-page buttons.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationButtons.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationButtons.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Pagination ranges</Typography>
            <Typography className="mb-16" component="div">You can specify how many digits to display either side of current page with the <code>{`siblingRange`}</code> prop, and adjacent to the start
                and end page number with the <code>{`boundaryRange`}</code> prop.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationRanges.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationRanges.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Controlled pagination</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationControlled.js').default}
                raw={require('!raw-loader!app/main/documentation/material-ui-components/components/pagination/PaginationControlled.js')}
            /></Typography>
            <Typography className="text-32 mt-32 mb-8" component="h2">Router integration</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
                component={require('app/main/documentation/material-ui-components/components/pagination/PaginationLink.js').default}
...
`}
            ...
            /></Typography>
            <Typography className="mb-16" component="div">You can learn more about this use case in the <a href="/components/tables/#custom-pagination-options">table section</a> of the documentation.</Typography>
            ...
            <Typography className="mb-16" component="div">The root node has a role of &quot;navigation&quot; and aria-label &quot;pagination navigation&quot; by default. The page items have an
                aria-label that identifies the purpose of the item (&quot;go to first page&quot;, &quot;go to previous page&quot;, &quot;go to page 1&quot; etc.). You can override these using
                the <code>{`getItemAriaLabel`}</code> prop.</Typography>
            <Typography className="text-24 mt-32 mb-8" component="h3">Keyboard</Typography>
            <Typography className="mb-16" component="div">The pagination items are in tab order, with a tabindex of &quot;0&quot;.</Typography>
