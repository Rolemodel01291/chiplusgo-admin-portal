...
function TooltipsDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div">When activated, <a href="https://material.io/design/components/tooltips.html">Tooltips</a> display a text label identifying an element, such
                as a description of its function.</Typography>
...
`}
            ...
            <Typography className="mb-16" component="div">You can find a similar concept in the <a href="/guides/composition/#wrapping-components">wrapping components</a> guide.</Typography>
            ...
            <Typography className="mb-16" component="div">You can use the <code>{`open`}</code>, <code>{`onOpen`}</code> and <code>{`onClose`}</code> properties to control the behavior of the tooltip.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div">A tooltip can be interactive. It won&#39;t close when the user hovers over the tooltip before the <code>{`leaveDelay`}</code> is
                expired.</Typography>
            <Typography className="mb-16" component="div"><FuseExample
                className="my-24"
                iframe={false}
            ...
            <Typography className="mb-16" component="div">By default disabled elements like <code>{`<button>`}</code> do not trigger user interactions so a <code>{`Tooltip`}</code> will not activate
                on normal events like hover. To accommodate disabled elements, add a simple wrapper element, such as a <code>{`span`}</code>.</Typography>
            <blockquote>
            ...
            /></Typography>
            <blockquote>
                <Typography className="mb-16" component="div">If you&#39;re not wrapping a Material-UI component that inherits from <code>{`ButtonBase`}</code>, for instance, a
                    native <code>{`<button>`}</code> element, you should also add the CSS property <em>pointer-events: none;</em> to your element when disabled:</Typography>
            </blockquote>
...
`}
            ...
            <Typography className="mb-16" component="div">The tooltip is normally shown immediately when the user&#39;s mouse hovers over the element, and hides immediately when the user&#39;s mouse
                leaves. A delay in showing or hiding the tooltip can be added through the properties <code>{`enterDelay`}</code> and <code>{`leaveDelay`}</code>, as shown in the Controlled Tooltips
                demo above.</Typography>
            <Typography className="mb-16" component="div">On mobile, the tooltip is displayed when the user longpresses the element and hides after a delay of 1500ms. You can disable this feature with
