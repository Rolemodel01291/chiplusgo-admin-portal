...
const MaterialUIComponentsRoutes = [
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/Autocomplete'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/BottomNavigation'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/Breadcrumbs'))
	},
	{
		path: '/documentation/material-ui-components/button-group',
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/ButtonGroup'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/ClickAwayListener'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/CssBaseline'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/FloatingActionButton'))
	},
	{
	...
	{
		path: '/documentation/material-ui-components/grid-list',
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/GridList'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/RadioButtons'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/TextareaAutosize'))
	},
	{
	...
	},
	{
		...
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/TransferList'))
	},
	{
		path: '/documentation/material-ui-components/transitions',
		component: lazy(() => import('app/main/documentation/material-ui-components/pages/Transitions'))
	},
	{
