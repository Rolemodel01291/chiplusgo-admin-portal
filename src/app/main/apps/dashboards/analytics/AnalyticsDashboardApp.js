...
import {selectDashboardWidgets, getDashboardWidgets} from './store/dashboardWidgetsSlice'
import Widget1 from '../project/widgets/Widget1';
...
function AnalyticsDashboardApp() {
	...
	if (_.isEmpty(dashboardWidgets)) {
		return null;
	}

	return (
		<div className="w-full">
			<Widget1 widget={dashboardWidgets.widget1} />
			<motion.div
